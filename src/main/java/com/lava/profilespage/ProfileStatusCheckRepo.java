 ...
 */
public class ProfileStatusCheckRepo extends ObjectsBase {
    public ProfileStatusCheckRepo(RemoteWebDriver driver){super(driver);}
    ...
    protected static WebElement statusofProfile;
