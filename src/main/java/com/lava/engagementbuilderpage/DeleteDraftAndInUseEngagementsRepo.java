 ...
 */
public class DeleteDraftAndInUseEngagementsRepo extends ObjectsBase {

    public DeleteDraftAndInUseEngagementsRepo(RemoteWebDriver driver){super(driver);}
    ...
    @FindBy(xpath = "//td[contains(.,'Automation')]")
    protected static List<WebElement> ProfileNameAutomation;

    @FindBy(xpath = "//div[@class=\"ui-tooltip-content\"]/descendant::b[contains(.,'Used by')]")
