 ...
 */
public class MobileInAppNotificationObjOptimized extends ObjectsBase {


    public MobileInAppNotificationObjOptimized(RemoteWebDriver driver){
        super(driver);
    }
    ...
    @FindBy(xpath = "//div[@class='field-item field-select ng-scope']/descendant::option[@class='ng-binding ng-scope']")
