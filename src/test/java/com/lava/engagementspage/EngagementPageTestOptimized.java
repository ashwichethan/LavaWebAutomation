 ...
 */
public class EngagementPageTestOptimized extends TestBase {
     ...
     //   Pages.Sidebar().clickEngagements();
        ...
        do {
            ...
            while (pattern != null && patternIndex <= 2) {
                ...
                //Clicking on header, body and footer. Also, expanding all the three options.
                //Click on header button and select headerValue
                Pages.MobileInAppNotificationOptimized().clickHeaderSelectType();
                Pages.MobileInAppNotificationOptimized().enterSelectedType(headerValue);




//                //Clicking on header, body and footer , i,e expanding all the three options.
//                switch (patternIndex) {
//                    case 0:
